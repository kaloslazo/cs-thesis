...
% La introducción oficial es el Capítulo I (capitulo1.tex). El archivo
% secciones/introduccion.tex conserva la plantilla no numerada como borrador
% y no se carga para evitar duplicar el planteamiento del problema.
